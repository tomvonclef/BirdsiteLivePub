...
public class SettingsManager
{
    ...
    public (DbSettings dbSettings, InstanceSettings instanceSettings) GetSettings()
    {
        ...
        do
        {
            ...
            do
            {
                ...
                if (resp is "n" or "no") data = null;

            } while (resp is not "y" and not "yes" and not "n" and not "no");
    ...
    private static LocalSettingsData GetLocalSettingsFile()
    {
        try
        {
    ...
    private static void SaveLocalSettings(LocalSettingsData data)
    {
