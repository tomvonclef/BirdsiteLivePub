...
public class App
{
    ...
    private readonly FollowersListState _state = new();
    ...
    public void Run()
    {
        ...
        static bool Quit()
        {
            var n = MessageBox.Query(50, 7, "Quit BSL Manager",
        ...
        filterText.KeyDown += _ =>
        {
            ...
            if (_.KeyEvent.Key != Key.Enter || string.IsNullOrWhiteSpace(text)) return;
